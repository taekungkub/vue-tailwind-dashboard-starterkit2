<template>
  <header class="flex items-center justify-between px-6 py-4 bg-white m-5 rounded-2xl">
    <div class="flex items-center">
      ...
      <div class="relative mx-4 lg:mx-0">
        ...
        <input
          class="w-32 pl-10 pr-4 py-2 text-indigo-600 border-2 border-gray-200 rounded-lg sm:w-64 focus:border-indigo-600 focus:ring focus:ring-opacity-40 focus:ring-indigo-500"
          type="text"
          placeholder="Search"
        />
      </div>
      ...
      <div class="relative">
        ...
        >
          <div v-show="dropdownOpen" class="absolute right-0 z-20 w-48 py-2 mt-2 bg-white rounded-md shadow-xl">
            ...
            <router-link to="/login" class="block px-4 py-2 text-sm text-gray-700 hover:bg-blue-500 hover:text-white">Log out</router-link>
          </div>
        </transition>
      </div>
    </div>
